            ...
            <Grid item xs={12} md={6}>
                <Card sx={{
                    ...
                    <Stack direction={{ xs: "column", sm: "row" }} >
                        <Box flex={1} sx={{
                            background: `linear-gradient(rgba(106,133,182,0.4), rgba(186,200,224,0.4)),  url(${"https://images.pexels.com/photos/3314294/pexels-photo-3314294.jpeg"}), center`,
                            ...
                            <Typography variant='span' fontSize={14} sx={{marginTop:'100px'}} >
